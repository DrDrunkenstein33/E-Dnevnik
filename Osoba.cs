...
namespace EDnevnik
{
    public partial class Osoba : Form
    {
        ...
        private void Txt_Load()
        {
            ...
            {
                txt_id.Text = tabela.Rows[broj]["id"].ToString();
                txt_ime.Text = tabela.Rows[broj]["ime"].ToString();
                txt_prezime.Text = tabela.Rows[broj]["prezime"].ToString();
                txt_adresa.Text = tabela.Rows[broj]["adresa"].ToString();
                txt_jmbg.Text = tabela.Rows[broj]["jmbg"].ToString();
                txt_email.Text = tabela.Rows[broj]["email"].ToString();
                txt_pass.Text = tabela.Rows[broj]["pass"].ToString();
                txt_uloga.Text = tabela.Rows[broj]["uloga"].ToString();
